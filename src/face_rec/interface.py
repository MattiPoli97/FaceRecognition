...
button_l = utils.Button_with_icon(button_x_l, button_y, button_width, button_height, "Giochiamo!",
                                    icon="./icons/icon_game.png")
button_r = utils.Button_with_icon(button_x_r, button_y, button_width, button_height, "Ricordiamo!",
                                    icon="./icons/icon_remember.png")

exit_button = utils.Button(x_exit, y_top, top_width, top_height, utils.RED, "X")
home_button = utils.Button_with_icon(x_home, y_top, top_width, top_height, icon="./icons/icon_home.png")

button_title = utils.Button(x_title, y_top, title_width, button_height, utils.WHITE, title)
    ...
    while leaves_running:
        ...
        for event in pygame.event.get():
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                utils.play_video_from_images(avatar, "./avatar/intro.mp4", screen, True, None,"Il giardino parlante ti dà il benvenuto!")
                ...
                while bg_running:
                    ...
                    button_title.draw(screen, utils.BLACK)
                    ...
                    for i, option_button in enumerate(self.option_buttons):
                        if option_button.is_clicked(pygame.mouse.get_pos()):
                            if option_button.is_correct(i, right_index):
                                ...
                                option_button.color = utils.Lava_red
                            option_button.draw(self.screen, utils.BLACK)
                            pygame.display.update()
